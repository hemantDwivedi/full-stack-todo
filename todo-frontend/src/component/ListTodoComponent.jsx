    ...
    return (
        <div>
            <div className="container mt-4">
                ...
                <div>
                    {isAdmin && <Link to='/add-todo' className="btn btn-info my-3">ADD TODO</Link>}
                        ...
                        <tbody>
                            {
                                todos.map(todo =>
                                    <tr key={todo.id}>
                                        ...
                                        <td>
                                            {isAdmin && <button className="btn btn-dark" onClick={() => updateTodo(todo.id)}>UPDATE</button>}
                                            {isAdmin && <button className="btn btn-info mx-2" onClick={() => deleteTodo(todo.id)}>DELETE</button>}
                                        </td>
                                    </tr>
                                )
                            }
